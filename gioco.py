...
def poss():
	...
	if poss == 1:
		...
		if turno%2 == 0:
			...
			print "Arrestato", nomi[random.randint(0,100)]+ " " + cognomi[random.randint(0,100)] ,", presidente della società"
			ele1 = ele1 - 20
			ele2 = ele2 - 20
			eleap = eleap - 10
