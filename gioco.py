...
eleap = 5
#aleciti = {"Sono il capo di una azienda, ti offro una sponsorizzazione da 3000Å, va bene?":3000}
#aloschi =
...
def poss():
	...
	if turno > 100 and difficile == "medio":
		print "Il gioco è finito!"
		exit()
	if turno > 165 and difficile == "facile":
		print "Il gioco è finito!"
		exit()"""
	...
	if poss == 1:
		...
		if elettori > 35:
			print "Elezioni Comunali: Eletti molti sindaci per il PIM!"
			sindaci = sindaci+ 3
			flop = flop - 1
			gioco()
		else:
			print "Sindaco di", sinistra, "non dichiara casa in Ticino: Solo una dimenticanza dice lui"
			ele2 = ele2 - 3
			gioco()
	elif poss == 3:
			print "Ministro di", destra, "chi non è con noi è un rosso di merda"
			ele1 = ele1 -3
			gioco()
	elif poss == 4:
		...
		print "Tutti i partiti organizzano il congresso elettorale!"
		soldi = soldi - 1000
		elettori = elettori + 3
		ele1 = ele1 + 3
		ele2 = ele2 - 3
		...
		sindaci = sindaci - 1
		elettori = elettori + random.randint(2,5) #prima era 8... suvvia, non siamo così puttanieri :D
		ele1 = ele1 + random.randint(-2,2)
		ele2 = ele2 + random.randint(-2,2)
		eleap = eleap + random.randint(-2,2)
		gioco()
	elif poss == 11:
		print "Arrestato ministro!"
		if premier == ss:
		...
		print "Corte Locale: Bestemmia diritto fondamentale"
		...
		print "Sindaco", destra, "sfila in mutande. Dannatamente divertente"
		gioco()
	elif poss == 45:
		...
		if turno %4 == 0:
			...
			print "Milano: Motore economico della Lombardia"
		gioco()
	elif poss == 52:
		print "Candidato PIM a Sesto ineleggibile, correrà Giuseppe Soggiorno, politico sconosciuto della zona."
		ele2 = ele2 + 4
		ele1 = ele1 + 4
		gioco()
	elif poss == 53:
		...
		if turno%2 == 0:
			...
			print "Arrestato", nomi[random.randint(0,165)]+ " " + cognomi[random.randint(0,165)] ,", presidente della società"
			ele1 = ele1 - 10
			ele2 = ele2 - 10
			eleap = eleap - 5
			elettori = elettori - 10
		...
		if lum == 1:
			...
			print "Partito perde causa: Pagherà 250Å"
			soldi = soldi - 250
		elif lum == 4:
			print "I nostri investimenti sono falliti. "
			soldi = soldi/1.5
		elif lum == 5 and random.randint(1,10) > 8:
			print "Donazioni aumentano!"
			soldi = soldi + 2500
			gioco()
		elif lum == 5:
			print "Milano rischia fallimento, i partiti si sacrificano"
			soldi = soldi - (soldi/4)
		elif lum == 6:
			print "Congresso di Partito domani!"
			soldi = soldi - 1000
			elettori = elettori + 2
		gioco()
		...
		if luma == 1:
			...
			print "Friuli ricchissimo: Una parte va a Milano e i pariti ci guadagnano"
			soldi = soldi + 10000
		elif luma == 3:
			print "Politici milanesi: I più produttivi. E vinciamo un premio"
			soldi = soldi + 25000
		elif luma == 4:
			print "Nuove zone industriali vicino Ferrara Indipendente fruttano"
			soldi = soldi + 2500
