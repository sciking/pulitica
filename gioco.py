...
sd = nomi[random.randint(0,110)]+ " " + cognomi[random.randint(0,110)]
ss = nomi[random.randint(0,110)]+ " " + cognomi[random.randint(0,110)]
premier = nomi[random.randint(0,110)]+ " " + cognomi[random.randint(0,110)]
si = nomi[random.randint(0,110)]+ " " + cognomi[random.randint(0,110)]
...
def poss():
	...
	if poss == 1:
		...
		if turno%2 == 0:
			...
			print "Arrestato", nomi[random.randint(0,110)]+ " " + cognomi[random.randint(0,110)] ,", presidente della società"
			ele1 = ele1 - 20
			ele2 = ele2 - 20
			eleap = eleap - 10
