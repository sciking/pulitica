...
def poss():
	...
	if poss == 1:
		...
		if lum == 1:
			...
			elettori = elettori + 2
		gioco()
	elif poss == 58: #qui si guadagnano i danè invece :D (me sora)
		luma = random.randint(1,6)
		if luma == 1:
			print "Scie idriche: Partito vince causa contro sostenitori"
			soldi = soldi + 1000
		elif luma == 2:
			print "Mantova ricchissima: Una parte va al Governo e i pariti ci guadagnano"
			soldi = soldi + 10000
		elif luma == 3:
